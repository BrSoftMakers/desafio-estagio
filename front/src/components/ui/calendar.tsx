    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 outline outline-1 outline-white text-white"
        ),
        ...
        day: cn(
          buttonVariants({ variant: "ghost" }),
          "h-9 w-9 p-0 rounded font-normal aria-selected:opacity-100 text-white"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-primary text-black rounded hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground focus:rounded",
        day_today: "bg-[#0056E2] text-black",
        day_outside:
